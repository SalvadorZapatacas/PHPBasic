...
class PreguntasModel 
{
    ...
    /*
     * Para recibir todas las preguntas
     */
    ...
    public static function insert($datos){
        ...
        $params = array (':asunto' => $datos['asunto'] , ':cuerpo' => $datos['cuerpo']);
    ...
    public static function edit($datos){
        ...
        if($errores_validacion){
            ...
            $sql = "UPDATE pregunta SET asunto=:asunto, cuerpo=:cuerpo WHERE id_pregunta=:id";
